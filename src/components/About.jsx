...
const About = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 right-0 w-96 h-96 bg-[#B83B5E]/5 rounded-full blur-3xl" />
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#B83B5E]/10 border border-[#B83B5E]/20 text-[#F08A5D] font-mono text-sm mb-4">
            <span className="w-1.5 h-1.5 rounded-full bg-[#F9ED69] animate-pulse" />
            ABOUT
          </span>
        ...
        >
          <p className="text-[#a1a1aa] text-lg md:text-xl leading-relaxed">
            ...
            specializing in <span className="text-[#F9ED69]">Distributed Computing</span> and <span className="text-[#F9ED69]">Software Product Lines</span>. 
